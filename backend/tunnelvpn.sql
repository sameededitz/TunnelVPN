...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 25, 2024 at 01:21 PM
...
--
-- Dumping data for table `dedicated_ip`
--

INSERT INTO `dedicated_ip` (`id`, `user_id`, `city`, `country`, `created_at`, `updated_at`) VALUES
(1, 1, 'Lahore', 'Pakistan', '2024-07-11 09:18:01', '2024-07-25 11:17:53');
...
CREATE TABLE `dedicated_servers` (
  `id` int(11) NOT NULL,
  `dedicated_ip_id` int(11) NOT NULL,
...
INSERT INTO `dedicated_servers` (`id`, `dedicated_ip_id`, `server_name`, `server_img`, `server_config`, `server_address`, `server_city`, `created_at`, `updated_at`) VALUES
(1, 1, 'Pakistan', 'pubg_668fcad15d425.png', 'Interface', '192.2919.29192.129', 'Faisalabad', '2024-07-11 10:13:46', '2024-07-11 12:06:41');
...
INSERT INTO `purchases` (`purchase_id`, `user_id`, `status`, `expiry_date`) VALUES
(12, 1, 'true', '2025-01-25 04:17:53 PM');
...
INSERT INTO `users` (`user_id`, `username`, `email`, `password`, `registration_date`, `last_login`, `is_verified`, `verification_token`, `remember_token`) VALUES
(1, 'admin', 'admin@gmail.com', '$2y$10$1ALjrPmOiNzEysa3XEsqs.Dl0qVsONAp42yoj9yx3zOswVIGOG4Gm', '2024-06-06 15:34:49', '2024-07-25 15:53:50', 1, NULL, 'd1f7be6798fd');
...
ALTER TABLE `dedicated_servers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `dedicated_ip_id` (`dedicated_ip_id`);
...
--
ALTER TABLE `dedicated_servers`
  ADD CONSTRAINT `dedicated_servers_ibfk_1` FOREIGN KEY (`dedicated_ip_id`) REFERENCES `dedicated_ip` (`id`);
